...
\address{\textbf{phone}: (34) 638 392 209 \\ 
         \textbf{email}: ivanvallesperez@gmail.com\ \\ 
         \textbf{skype}:\ ivallesp\ \\
         \textbf{addr.}: C/Ibiza\ 13, BA, 28009, Madrid }
         
\address{\textbf{github}: \url{github.com/ivallesp}   \\ 
        \textbf{kaggle}: \url{kaggle.com/ivallesp} \ \\ 
        \textbf{webpage}: \url{www.uv.es/ivape3}}
